...
namespace Data_Access_Fake
{
    public class fileReadFake : iFile_Read
    {
        ...
        public void readdata()
        {
            ...
            _ = new Column("user_id", "int", 0, "", "", 100000, 1, 'n', "no", 'n', 'y', "no", "", "", "The user_Id");
            _ = new Column("user_name", "nvarchar", 100, "", "", 0, 0, 'n', "no", 'y', 'n', "no", "", "", "The user handle");
            _ = new Column("user_pass", "nvarchar", 100, "", "", 0, 0, 'n', "no", 'n', 'n', "no", "", "", "The user handle");
